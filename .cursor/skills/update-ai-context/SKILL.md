...
description: >-
  ...
  usuario invoque /update-ai-context, pida planificar trabajo o dé instrucciones
  que deban quedar reflejadas en el contexto del proyecto (stack, estructura,
  modelos, reglas, backlog).
---

# /update-ai-context — Mantenimiento de AI_CONTEXT
